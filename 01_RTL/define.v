...
// MEDIAN STATE
`define Median_State_Idle       5'b01111
`define Median_State_Read_0     5'b01100
`define Median_State_Read_1     5'b01101
`define Median_State_Read_2     5'b00011
`define Median_State_Read_3     5'b00000
`define Median_State_Read_4     5'b00001
`define Median_State_Read_5     5'b00111
